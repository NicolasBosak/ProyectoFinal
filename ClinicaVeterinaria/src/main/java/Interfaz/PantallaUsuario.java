...
public class PantallaUsuario extends javax.swing.JFrame{
    ...
    void agregar(){
        ...
        dtm.addRow(new Object[]{NombreVoluntario.getText(),
                ApellidoVoluntario.getText(),
                Integer.parseInt(DiaN.getText()),
                Integer.parseInt(MesN.getText()),
                Integer.parseInt(AnioN.getText()),
