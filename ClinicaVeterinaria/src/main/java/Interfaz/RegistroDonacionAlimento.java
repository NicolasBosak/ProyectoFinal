...
public class RegistroDonacionAlimento extends javax.swing.JFrame{
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // Validar que el día, mes y año sean números
        try {
            ...
            // Validar que la cantidad de donaciones sea un número y esté en kilos
            try {
                double donaciones = Double.parseDouble(canDonacion.getText());
                ...
                // Actualizar la suma acumulada de donaciones
                totalDonaciones += donaciones;

                // Verificar si el último usuario ha superado el total de donaciones
                if (totalDonaciones > 7000) {
                    // Actualizar la donación del último usuario para que no supere el total
                    donaciones -= (totalDonaciones - 7000);
                    totalDonaciones = 7000;
                }

                // Mostrar un mensaje con el total de donaciones actualizado
                JOptionPane.showMessageDialog(this, "Total de donaciones: " + totalDonaciones,
                        "Total de donaciones actualizado", JOptionPane.INFORMATION_MESSAGE);
            } catch (NumberFormatException e) {
                // Mostrar un mensaje de error si la cantidad de donaciones no es un número válido
                JOptionPane.showMessageDialog(this, "Ingrese la cantidad de donaciones en kilos",
                        "Error de validación", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException e) {
            // Mostrar un mensaje de error si el día, mes o año no son números válidos
            JOptionPane.showMessageDialog(this, "Ingrese números válidos para el día, mes y año",
                    "Error de validación", JOptionPane.ERROR_MESSAGE);
        }


        // Agregar la fila a la tabla
        dtm.addRow(new Object[]{alimentoDonado});
